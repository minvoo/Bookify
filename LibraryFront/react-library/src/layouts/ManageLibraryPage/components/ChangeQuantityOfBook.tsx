        ...
        <div className="mt-3 shadow p-3 mb-3 bg-body rounded">
            <div className="row g-0">
                ...
                <div className="mt-3 col-md-1">
                    <div onClick={deleteBook}className="d-flex justify-content-start"><button className="m-1 btn btn-md btn-danger">Delete</button>
                    </div>
                </div>
                <button onClick={increaseQuantity} className="m1 btn btn-md main-color text-white">Add quantity</button>
                <button onClick={decreaseQuantity}className="m1 mt-2 btn btn-md btn-warning text-white">Decrease quantity</button>
            </div>
        </div>
    );
}